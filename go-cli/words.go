...
func registerSDKWords(r *eng.Registry, client *sdk.CatFactSDK) {
...
func runOp(client *sdk.CatFactSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
