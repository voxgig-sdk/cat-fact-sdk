...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Fact()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/cat-fact-sdk/releases)) or
...
```
py/
├── catfact_sdk.py         -- Main SDK module
