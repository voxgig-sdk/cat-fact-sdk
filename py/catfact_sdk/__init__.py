...
from catfact_sdk.utility import register

# Load features
from catfact_sdk.feature.base_feature import CatFactBaseFeature
from catfact_sdk.features import _has_feature, _make_feature
...
class CatFactSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = CatFactUtility()
        self._utility = utility

        from catfact_sdk.config import shared_config
    ...
    def get_utility(self):
        return CatFactUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CatFactSDK: graphql: " + str(msg))
            res["graphql"] = errors
