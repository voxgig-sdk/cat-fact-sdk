...
class CatFactTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CatFactTestRunner.getenv("CAT_FACT_TEST_LIVE")
        override = CatFactTestRunner.getenv("CAT_FACT_TEST_OVERRIDE")
        ...
        explain = CatFactTestRunner.getenv("CAT_FACT_TEST_EXPLAIN")
