...
class CatFactTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CatFactTestRunner.getenv("CATFACT_TEST_LIVE")
        override = CatFactTestRunner.getenv("CATFACT_TEST_OVERRIDE")
        ...
        explain = CatFactTestRunner.getenv("CATFACT_TEST_EXPLAIN")
