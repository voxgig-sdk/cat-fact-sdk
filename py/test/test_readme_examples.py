# CatFact SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CatFactSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CatFactSDK(...) and CatFactSDK.test(...) become
#      CatFactSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "catfact_sdk"
_SDK_CLASS = "CatFactSDK"
