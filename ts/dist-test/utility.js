...
function envOverride(m) {
    if ('TRUE' === process.env.CAT_FACT_TEST_LIVE ||
        'TRUE' === process.env.CAT_FACT_TEST_OVERRIDE) {
    ...
    m.CAT_FACT_TEST_EXPLAIN = process.env.CAT_FACT_TEST_EXPLAIN || m.CAT_FACT_TEST_EXPLAIN;
    return m;
}
