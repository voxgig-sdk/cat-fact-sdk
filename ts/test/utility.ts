...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.CATFACT_TEST_LIVE ||
    'TRUE' === process.env.CATFACT_TEST_OVERRIDE
  ) {
  ...
  m.CATFACT_TEST_EXPLAIN = process.env.CATFACT_TEST_EXPLAIN || m.CATFACT_TEST_EXPLAIN
