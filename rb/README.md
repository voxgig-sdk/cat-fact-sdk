...
The Ruby SDK for the CatFact API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `CatFactError` (a `StandardError` subclass), so wrap
...
```
rb/
├── CatFact_sdk.rb       -- Main SDK module
...
The main module (`CatFact_sdk`) exports the SDK class
