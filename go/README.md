...
The Golang SDK for the CatFact API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/cat-fact-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/cat-fact-sdk=../path/to/github.com/voxgig-sdk/cat-fact-sdk
```
...
All entities implement the `CatFactEntity` interface.
...
```
github.com/voxgig-sdk/cat-fact-sdk/
├── cat-fact.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/cat-fact-sdk`) re-exports everything needed
