...
func (sdk *CatFactSDK) OptionsMap() map[string]any {
...
func (sdk *CatFactSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *CatFactSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *CatFactSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CatFactSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *CatFactSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *CatFactSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("CatFactSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *CatFactSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CatFactSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("CatFactSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *CatFactSDK {
	if sdkopts == nil {
