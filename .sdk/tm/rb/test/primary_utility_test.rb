...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = CatFactOmni.make_runner(TEST_JSON_FILE, CatFactSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : CatFactOmni.errify(err)
    end
