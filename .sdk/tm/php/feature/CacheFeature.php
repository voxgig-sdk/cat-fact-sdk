...
class CatFactCacheFeature extends CatFactBaseFeature
{
    ...
    private function _through(CatFactContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
