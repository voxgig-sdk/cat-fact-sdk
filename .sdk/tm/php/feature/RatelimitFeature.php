...
class CatFactRatelimitFeature extends CatFactBaseFeature
{
    ...
    private function _acquire(CatFactContext $ctx): void
    {
    ...
    private function _track(CatFactContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
