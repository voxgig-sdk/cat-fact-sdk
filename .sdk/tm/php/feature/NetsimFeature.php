...
class CatFactNetsimFeature extends CatFactBaseFeature
{
    ...
    private function _simulate(CatFactContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CatFactContext $ctx, array $applied): void
    {
        $client = $this->client;
