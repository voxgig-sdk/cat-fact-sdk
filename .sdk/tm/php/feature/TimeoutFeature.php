...
class CatFactTimeoutFeature extends CatFactBaseFeature
{
    ...
    private function _with_timeout(CatFactContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CatFactContext $_ctx, float $ms): void
    {
        $client = $this->client;
