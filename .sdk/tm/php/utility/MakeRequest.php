...
// CatFact SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CatFactMakeRequest
{
    public static function call(CatFactContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CatFactResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CatFactResponse($fetched);
        } else {
