...
// CatFact SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CatFactOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CatFactOmni::structfix($now, Struct::undef()))
                        !== json_encode(CatFactOmni::structfix($val, Struct::undef()))) {
