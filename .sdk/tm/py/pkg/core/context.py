...
from projectname_sdk.core.control import CatFactControl
...
class CatFactContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, CatFactResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CatFactError(code, msg, self)
