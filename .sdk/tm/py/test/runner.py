...
class CatFactTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CatFactTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = CatFactTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = CatFactTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
