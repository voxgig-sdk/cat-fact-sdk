...
from projectname_sdk import CatFactSDK
from projectname_sdk.core.spec import CatFactSpec
from projectname_sdk.core.result import CatFactResult
from projectname_sdk.core.response import CatFactResponse
from projectname_sdk.core.operation import CatFactOperation
from projectname_sdk.core.error import CatFactError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import CatFactBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = CatFactSDK.test(None, None)
        ...
        class TestInitFeature(CatFactBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(CatFactBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = CatFactSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CatFactSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CatFactSDK.test(None, setup_opts)
