...
|---|---|---|
| `ts/` | @voxgig-sdk/cat-fact-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/cat-fact-sdk \
      --repository voxgig-sdk/cat-fact-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/cat-fact-sdk` shows it, and
`npm trust revoke @voxgig-sdk/cat-fact-sdk --id=<id>` removes it.
