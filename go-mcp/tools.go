...
type Args struct {
	Entity string         `json:"entity" jsonschema:"fact | user"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CatFactSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "cat-fact_list",
		Description: "List records from CatFact. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "cat-fact_load",
		Description: "Load a single record from CatFact. " +
...
func runOp(client *sdk.CatFactSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CatFactSDK, name string) (sdk.CatFactEntity, error) {
