...
class CatFactRbacFeature extends CatFactBaseFeature
{
    ...
    private function _required(CatFactContext $ctx): ?string
    {
    ...
    private function _reject(CatFactContext $ctx, string $required): void
    {
    ...
    private function _track(CatFactContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
