...
class CatFactProxyFeature extends CatFactBaseFeature
{
    ...
    public function init(CatFactContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CatFactContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
