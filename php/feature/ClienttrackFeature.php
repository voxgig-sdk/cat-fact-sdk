...
// CatFact SDK clienttrack feature
...
class CatFactClienttrackFeature extends CatFactBaseFeature
{
    ...
    public function PostConstruct(CatFactContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CatFact-SDK';
