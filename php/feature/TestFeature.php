...
// CatFact SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CatFactTestFeature extends CatFactBaseFeature
{
    ...
    public function init(CatFactContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CatFactContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CatFactContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CatFactContext $ctx, $op, $args): array
    {
