...
class CatFactStreamingFeature extends CatFactBaseFeature
{
    ...
    private function _iterate(CatFactResult $result): \Generator
    {
    ...
    private function _streamable(CatFactContext $ctx): bool
    {
