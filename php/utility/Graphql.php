...
class CatFactGraphql
{
    ...
    // equivalent.
    public static function body(CatFactContext $ctx): mixed
    {
    ...
    public static function errors(CatFactContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
