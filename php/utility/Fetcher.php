...
class CatFactFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CatFactSDK/1.0)';
    ...
    public static function call(CatFactContext $ctx, string $fullurl, array $fetchdef): array
    {
