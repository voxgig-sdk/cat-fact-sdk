# CatFact PHP SDK Reference

Complete API reference for the CatFact PHP SDK.
...
#### `CatFactSDK::test($testopts = null, $sdkopts = null)`
...
```php
[$result, $err] = $client->Fact()->load(["id" => "fact_id"]);
```
