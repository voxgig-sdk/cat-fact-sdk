...
// CatFact SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CatFactSDK::test)
...
{
    private const SDK_CLASS = 'CatFactSDK';
    ...
    private const SDK_BASE = 'catfact_sdk';
