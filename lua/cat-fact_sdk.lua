...
CatFactSDK._make_feature = _make_feature


function CatFactSDK.new(options)
  local self = setmetatable({}, CatFactSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function CatFactSDK:options_map()
...
function CatFactSDK:get_utility()
  return Utility.copy(self._utility)
end


function CatFactSDK:get_root_ctx()
  return self._rootctx
end


function CatFactSDK:prepare(fetchargs)
...
function CatFactSDK:direct(fetchargs)
...
-- by passing it.
function CatFactSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function CatFactSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "CatFactSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function CatFactSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = CatFactSDK.new(sdkopts)
  sdk.mode = "test"
